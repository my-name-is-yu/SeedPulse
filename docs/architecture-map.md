...
| `knowledge-acquisition.md` | 知識獲得（知識不足検知・調査タスク・DomainKnowledge保存） | observation.md, task-lifecycle.md | goal-negotiation.md | Phase 2 |
| `portfolio-management.md` | ポートフォリオ管理（StrategyManager、複数戦略並列実行） | drive-scoring.md, stall-detection.md | task-lifecycle.md | 設計済み |

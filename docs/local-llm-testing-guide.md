...
> - Chat can use the native AgentLoop path when the configured model supports tool calling> - If frozen, press `Ctrl-C` or run `pkill -f "node dist/interface/cli/cli-runner.js"` from another terminal pane

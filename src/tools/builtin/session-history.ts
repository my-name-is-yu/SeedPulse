...
export class SessionHistoryTool implements ITool<SessionHistoryInput, unknown> {
  readonly metadata: ToolMetadata = {
    ...
    maxConcurrency: 0,
    maxOutputChars: 8000,
    tags: ["observe", "session", "self-grounding"],
  };
  ...
  description(_context?: ToolDescriptionContext): string {
    return "Observe recent PulSeed session history. Returns session summaries including task executed, strategy used, observations, and outcome.";
  }

...
export class TestRunnerTool implements ITool<TestRunnerInput, TestRunnerOutput> {
  readonly metadata: ToolMetadata = {
    ...
    tags: ["observe", "test", "verification"],
  };

  readonly inputSchema = TestRunnerInputSchema;

  description(): string {
    return "Run a test suite and return structured results (passed/failed/skipped counts). Supports vitest, jest, and mocha output formats.";
  }

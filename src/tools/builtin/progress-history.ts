  ...
  implements ITool<ProgressHistoryInput, ProgressHistoryOutput>
{
  readonly metadata: ToolMetadata = {
    ...
    maxConcurrency: 0,
    maxOutputChars: 8000,
    tags: ["observe", "progress", "self-grounding"],
  };
  ...
  description(_context?: ToolDescriptionContext): string {
    return "Retrieve time-series progress history for a goal's dimensions. Returns dimension gap values per iteration and a trend label (improving/stagnating/declining/insufficient_data).";
  }
